...
<template>
  <div>
    <div class="w-full px-6 pb-4 bg-center bg-no-repeat bg-cover rounded-lg bg-card-bg-yellow">
      <div class="flex">
        <div class="flex flex-col text-3xl text-red-600 font-Rubik mt-11">
          ...
          <div class="flex mb-4 text-lg mt-7">
            ...
            <input
              maxlength="10"
              v-model="to"
              class="text-black underline bg-none underline-black font-Saemaul"
              type="text"
              placeholder="해적왕 호랭이"
            />
          </div>
