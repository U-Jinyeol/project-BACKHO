...
watch(
  ...
  () => {
    console.log(to.value, from.value);
...
<template>
  <div class="bg-red-300">
    <div class="w-full px-6 pb-4 bg-red-400 rounded-lg">
      <div class="flex">
        <div class="flex flex-col text-3xl text-red-600 font-Rubik mt-11">
          <p>Merry</p>
          <p>Christmas</p>
          <div class="flex text-lg mt-7">
            <p class="mr-1 text-white font-Rubik">to.</p>
            <input
              maxlength="10"
              v-model="to"
              class="text-white underline bg-red-400 underline-white font-Saemaul"
              type="text"
              placeholder="해적왕 호랭이"
            />
          </div>
        </div>
        <img src="@/assets/image/card/card-tiger.webp" alt="" class="h-auto mt-7 w-28" height="auto" />
      </div>
      <div class="relative flex flex-col">
        <img src="@/assets/image/card/card-tape.webp" alt="" class="absolute left-0 right-0 w-20 mx-auto -top-3" />
        <textarea
          v-model="content"
...
마무리 잘 하시고, 행복한 크리스마스 보내길 바랍니다. Merry Christmas!"
        />
        <img src="@/assets/image/card/card-flower.svg" class="absolute left-0 right-0 mx-auto bottom-1 w-9" />
      </div>
